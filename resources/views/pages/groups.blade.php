...
<div class="content">
    ...
    <div class="products-listing" style="margin-top: 24px; overflow: hidden;" data-page="1" data-sort="DESC">
        ...
        <a href="{{ baseUrl() . '/' . trans('group') . '/' . $group->data->url }}" class="category-box-link">
            <div class="category-box">
                <div class="category-box-img" style="background-image: url('{{ url() . '/media/group/' . $group->thumbnail }}');"></div>
                <p class="category-box-title">{{ $group->data->title }}</p>
            </div>
        </a>
        @endforeach
    </div>
