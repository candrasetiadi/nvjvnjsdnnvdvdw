...
<div class="content">
    ...
    <div class="products-listing" style="margin-top: 24px; overflow: hidden;" data-page="1" data-sort="DESC">
        ...
        <a href="{{ baseUrl() . '/' . trans('subcategory') . '/' . $sub->data->url }}" class="category-box-link">
            <div class="category-box">
                <div class="category-box-img" style="background-image: url('{{ url() . '/media/subcategories/' . $sub->thumbnail }}');"></div>
                <p class="category-box-title">{{ $sub->data->title }}</p>
            </div>
        </a>
        @endforeach
        @else
